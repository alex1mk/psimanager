            ...
            <tbody className="divide-y divide-gray-100">
              {filteredPatients.map((patient) => (
                <tr key={patient.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-slate-700">{patient.fixedDay}</div>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-2 grid grid-cols-2 gap-6 bg-slate-50 p-4 rounded-lg border border-slate-100">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">Data da Primeira Consulta</label>
                    <div className="relative">
                      {/* 
                         FORCE CSS OVERRIDES:
                         [&::-webkit-calendar-picker-indicator]:opacity-0 -> Hides native icon
                      ...
                      */}
                      ...
                      />
                      {/* Icon overlay with pointer-events-none to allow click-through */}
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 font-medium transition-colors disabled:opacity-70"
                >
                  {isLoading ? (
                    <>
