...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] flex font-sans text-slate-900">
      ...
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 w-full bg-[#004D40] text-white z-20 shadow-md px-4 py-3 flex justify-between items-center">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-30 bg-slate-900/50" onClick={() => setMobileMenuOpen(false)}>
            <div className="bg-[#004D40] w-64 h-full pt-16 flex flex-col justify-between" onClick={e => e.stopPropagation()}>
      ...
      <main 
        className={`flex-1 p-6 md:p-10 pt-20 md:pt-10 transition-all duration-300 ease-in-out ${
