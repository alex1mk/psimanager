...
serve(async (req) => {
    try {
        ...
        const projectUrl = Deno.env.get("SUPABASE_URL") ?? "https://[YOUR_PROJECT_REF].supabase.co"
        ...
        console.log(`Sending Notifications -> Email: ${toEmail}, WhatsApp: ${toPhone}`)
      ...
      `,
        ...
        const twilioSender = Deno.env.get("TWILIO_PHONE_NUMBER") || "whatsapp:+14155238886"
